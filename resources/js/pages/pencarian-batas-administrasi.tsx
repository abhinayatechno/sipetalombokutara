...
export default function PencarianBatasAdministrasi() {
    ...
    return (
        <>
            <Head title="Pencarian Batas Administrasi - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara">
                <link rel="canonical" href={getCanonicalUrl('/pencarian-batas-administrasi')} />
                <meta
                    name="description"
                    content="Lihat informasi batas administrasi desa dan kecamatan di Kabupaten Lombok Utara melalui SIPETA."
                />
                <meta
                    property="og:title"
                    content="Pencarian Batas Administrasi - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara"
                />
                <meta
                    property="og:description"
                    content="Akses informasi batas administrasi desa dan kecamatan di Kabupaten Lombok Utara."
                />
