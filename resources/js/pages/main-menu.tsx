...
export default function MainMenu() {
    ...
    return (
        <>
            <Head title="Main Menu - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara">
                <link rel="canonical" href={getCanonicalUrl('/main-menu')} />
                <meta
                    name="description"
                    content="Akses menu utama SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara untuk pencarian bidang tanah, batas administrasi, brankas elektronik, dan layanan geospasial."
                />
                <meta
                    property="og:title"
                    content="Main Menu - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara"
                />
                <meta
                    property="og:description"
                    content="Menu utama SIPETA untuk mengakses layanan pencarian bidang tanah, batas administrasi, brankas elektronik, dan dokumen geospasial di Kabupaten Lombok Utara."
                />
