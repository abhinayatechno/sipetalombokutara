...
export default function BrankasElektronik() {
    ...
    return (
        <>
            <Head title="Brankas Elektronik - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara">
                <link rel="canonical" href={getCanonicalUrl('/brankas-elektronik')} />
                <meta
                    name="description"
                    content="Akses dokumen digital dan peta wilayah Kabupaten Lombok Utara melalui brankas elektronik SIPETA."
                />
                <meta
                    property="og:title"
                    content="Brankas Elektronik - SIPETA (Sistem Pencarian Tanah) Kabupaten Lombok Utara"
                />
                <meta
                    property="og:description"
                    content="Pencarian dokumen digital dan peta wilayah Kabupaten Lombok Utara melalui brankas elektronik SIPETA."
                />
